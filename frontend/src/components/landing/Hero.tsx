...
// Lazy load GridScan to prevent React Three Fiber reconciler errors
const GridScan = lazy(() => import('@/components/ui/GridScan'));
...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      {/* GridScan Animated Background - Temporarily disabled due to React Three Fiber reconciler error */}
      {/* TODO: Fix React Three Fiber version compatibility issue */}
      {/*
      <div className="absolute inset-0 w-full h-full">
        <Suspense fallback={<div className="absolute inset-0 bg-background/5" />}>
          <GridScan
            sensitivity={0.55}
            lineThickness={1.2}
            linesColor="#8B7AA8"
      ...
      */}
      ...
      <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-purple-900/10 via-background to-blue-900/10" />
